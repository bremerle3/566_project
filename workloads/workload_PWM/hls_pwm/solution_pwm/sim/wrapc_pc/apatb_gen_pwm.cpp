...
extern "C" void gen_pwm (int duty, int freq, char* out);
#define gen_pwm AESL_ORIG_DUT_gen_pwm
extern "C" void gen_pwm (int duty, int freq, char* out);
#undef gen_pwm
void gen_pwm (int duty, int freq, char* out) {
    ...
    if (wrapc_switch_file_token.good()) {
            ...
            if (i > 0) {
                ...
                for (int i_0 = 0; i_0 <= 0 ; i_0+= 1) {
                    ...
                    if(&(out[0]) != 0) {
                       ...
                       out_lv0_0_0_1[0 + AESL_i].range(7, 0) = sc_bv<8>(out_r_pc_buffer[0 + AESL_i].range(7, 0));
        ...
        sc_lv<8> out_tmp_mem; 
            ...
            out_tmp_mem = out[i_0];
               ...
               out_r_tvout_wrapc_buffer[0 + AESL_i].range(7, 0) = out_tmp_mem.range(7, 0 ) ;
