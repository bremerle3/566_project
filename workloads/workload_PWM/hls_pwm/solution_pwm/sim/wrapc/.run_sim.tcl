...
set ::env(LD_LIBRARY_PATH) /project/linuxlab/xilinx/xilinx/Vivado_HLS/Vivado_HLS/lnx64/tools/fpo_v7_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /project/linuxlab/xilinx/xilinx/Vivado_HLS/Vivado_HLS/lnx64/tools/opencv:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /project/linuxlab/xilinx/xilinx/Vivado_HLS/Vivado_HLS/lnx64/tools/fft_v9_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /project/linuxlab/xilinx/xilinx/Vivado_HLS/Vivado_HLS/lnx64/tools/fir_v7_0:$::env(LD_LIBRARY_PATH)
...
upvar ::AESL_AUTOSIM::DirAutoSimRoot  DirAutoSimRoot
    ...
    set gWorkingDir             "../.."
    set constFileTvIn           "gen_pwm.autotvin.dat"
    set constFileTvOut          "gen_pwm.autotvout.dat"
    set constFileHdlTvIn        "gen_pwm.autohdltvin.dat"
    set constFileHdlTvOut       "gen_pwm.autohdltvout.dat"
    set gGateLevelSim           "0"
    set gAutowrap               "1"
    set gTool                   "modelsim"
