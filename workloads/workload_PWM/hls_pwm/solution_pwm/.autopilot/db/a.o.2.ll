...
define void @gen_pwm(i32 %duty, i32 %freq, i8* %out) nounwind uwtable {
  call void (...)* @_ssdm_op_SpecBitsMap(i32 %duty) nounwind, !map !25
  call void (...)* @_ssdm_op_SpecBitsMap(i32 %freq) nounwind, !map !31
  call void (...)* @_ssdm_op_SpecBitsMap(i8* %out) nounwind, !map !35
  call void (...)* @_ssdm_op_SpecTopModule([8 x i8]* @str) nounwind
  call void @llvm.dbg.value(metadata !{i32 %duty}, i64 0, metadata !41), !dbg !42 ; [debug line = 4:22] [debug variable = duty]
  call void @llvm.dbg.value(metadata !{i32 %freq}, i64 0, metadata !43), !dbg !44 ; [debug line = 4:36] [debug variable = freq]
  call void @llvm.dbg.value(metadata !{i8* %out}, i64 0, metadata !45), !dbg !46 ; [debug line = 4:51] [debug variable = out]
  call void (...)* @_ssdm_op_SpecInterface(i32 0, [14 x i8]* @.str, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1, [1 x i8]* @.str1) nounwind, !dbg !47 ; [debug line = 6:1]
  call void (...)* @_ssdm_op_SpecResourceLimit(i32 1, [4 x i8]* @.str2, [1 x i8]* @.str1, [1 x i8]* @.str1, [1 x i8]* @.str1) nounwind, !dbg !47 ; [debug line = 6:1]
  br label %1, !dbg !49                           ; [debug line = 7:9]

; <label>:1                                       ; preds = %2, %0
  %i = phi i31 [ 0, %0 ], [ %i.1, %2 ]            ; [#uses=2 type=i31]
  %i.cast = zext i31 %i to i32, !dbg !49          ; [#uses=2 type=i32] [debug line = 7:9]
  %tmp = icmp slt i32 %i.cast, %freq, !dbg !49    ; [#uses=1 type=i1] [debug line = 7:9]
  br i1 %tmp, label %2, label %3, !dbg !49        ; [debug line = 7:9]

; <label>:2                                       ; preds = %1
  %tmp.1 = icmp slt i32 %i.cast, %duty, !dbg !51  ; [#uses=1 type=i1] [debug line = 9:9]
  %storemerge = zext i1 %tmp.1 to i8, !dbg !51    ; [#uses=1 type=i8] [debug line = 9:9]
  store i8 %storemerge, i8* %out, align 1, !dbg !53 ; [debug line = 11:13]
  %i.1 = add i31 %i, 1, !dbg !55                  ; [#uses=1 type=i31] [debug line = 7:20]
  call void @llvm.dbg.value(metadata !{i31 %i.1}, i64 0, metadata !56), !dbg !55 ; [debug line = 7:20] [debug variable = i]
  br label %1, !dbg !55                           ; [debug line = 7:20]

; <label>:3                                       ; preds = %1
  ret void, !dbg !57                              ; [debug line = 20:1]
}
...
!28 = metadata !{metadata !"duty", metadata !29, metadata !"int", i32 0, i32 31}
!29 = metadata !{metadata !30}
!30 = metadata !{i32 0, i32 0, i32 0}
!31 = metadata !{metadata !32}
!32 = metadata !{i32 0, i32 31, metadata !33}
!33 = metadata !{metadata !34}
!34 = metadata !{metadata !"freq", metadata !29, metadata !"int", i32 0, i32 31}
!35 = metadata !{metadata !36}
!36 = metadata !{i32 0, i32 7, metadata !37}
!37 = metadata !{metadata !38}
!38 = metadata !{metadata !"out", metadata !39, metadata !"signed char", i32 0, i32 7}
!39 = metadata !{metadata !40}
!40 = metadata !{i32 0, i32 0, i32 1}
!41 = metadata !{i32 786689, metadata !5, metadata !"duty", metadata !6, i32 16777220, metadata !9, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!42 = metadata !{i32 4, i32 22, metadata !5, null}
!43 = metadata !{i32 786689, metadata !5, metadata !"freq", metadata !6, i32 33554436, metadata !9, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!44 = metadata !{i32 4, i32 36, metadata !5, null}
!45 = metadata !{i32 786689, metadata !5, metadata !"out", metadata !6, i32 50331652, metadata !11, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!46 = metadata !{i32 4, i32 51, metadata !5, null}
...
!49 = metadata !{i32 7, i32 9, metadata !50, null}
!50 = metadata !{i32 786443, metadata !48, i32 7, i32 5, metadata !6, i32 1} ; [ DW_TAG_lexical_block ]
!51 = metadata !{i32 9, i32 9, metadata !52, null}
!52 = metadata !{i32 786443, metadata !50, i32 8, i32 5, metadata !6, i32 2} ; [ DW_TAG_lexical_block ]
!53 = metadata !{i32 11, i32 13, metadata !54, null}
!54 = metadata !{i32 786443, metadata !52, i32 10, i32 9, metadata !6, i32 3} ; [ DW_TAG_lexical_block ]
!55 = metadata !{i32 7, i32 20, metadata !50, null}
!56 = metadata !{i32 786688, metadata !48, metadata !"i", metadata !6, i32 6, metadata !9, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!57 = metadata !{i32 20, i32 1, metadata !48, null}
