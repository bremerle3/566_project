...
set_svf ./initial/svf/interconnect_ip.svf
...
set ::rtRefDes interconnect_ip
read_sdc -version 1.9 -echo ./constrain/script/interconnect_ip.sdc
...
# Target Library : vtvt_tsmc180
#
##############################################################################


  set rtReportBase interconnect_ip
...
#      report_timing -from $rtQpins -to $rtDpins -path only -max_paths 25 -nosplit 
  ...
  redirect $rtRptOut {
    echo "RPT_INFO:Time Scale 1000"
    echo ""
    echo "RPT_INFO:Time Units ps"
    echo ""
    report_qor -nosplit
  }
...
redirect $rtAreaRpt {
  echo "RPT_INFO:Area Scale 36.7416"
