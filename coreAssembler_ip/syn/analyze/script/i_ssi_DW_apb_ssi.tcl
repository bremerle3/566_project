...
set rt_files_to_analyze { \
  ../src/DW_apb_ssi_cc_constants.v
  ../src/DW_apb_ssi_bcm_params.v
  ../src/DW_apb_ssi_bcm57.v
  ../src/DW_apb_ssi_bcm06.v
  ../src/DW_apb_ssi_bcm21.v
  ../src/DW_apb_ssi_rxsr.v
  ../src/DW_apb_ssi_txsr.v
  ../src/DW_apb_ssi_biu.v
  ../src/DW_apb_ssi_regfile.v
  ../src/DW_apb_ssi_sclkgen.v
  ../src/DW_apb_ssi_fifo.v
  ../src/DW_apb_ssi_shift.v
  ../src/DW_apb_ssi_mstfsm.v
  ../src/DW_apb_ssi_slvfsm.v
  ../src/DW_apb_ssi_dma.v
  ../src/DW_apb_ssi_intctl.v
  ../src/DW_apb_ssi.v
  ../src/DW_apb_ssi-undef.v
}
