...
set_svf ./qmap/svf/i_ahb_DW_ahb.svf
...
compile -no_design_rule -area_effort none -map_effort medium
if {[check_error]} {
...
change_names -hierarchy -rules verilog -log_changes /home/warehouse/lbremer/566_project/coreAssembler_ip/components/i_ahb/gtech/db/change_names.log
...
##############################################################################
  ...
  set rtReportBase DW_ahb
  set rtCurrentDesign [get_attribute [current_design] Name]
  set rtReportDir ./qmap/report
  set rtScriptDir ./qmap/script
...
exec $perlExec /project/linuxlab/synopsys/coreTools/linux/dware/bin/gen_html_reports.pl -d ./qmap/report -r /project/linuxlab/synopsys/coreTools
