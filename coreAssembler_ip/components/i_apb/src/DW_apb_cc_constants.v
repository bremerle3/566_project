...
`define START_PADDR_0 32'h00020000
...
// Dependencies: The decoder must be configured as internal 
// (when APB_HAS_XDCDR = 0).
`define START_PADDR_1 32'h00021000
...
// Dependencies: The decoder must be configured as internal 
// (when APB_HAS_XDCDR = 0).
`define END_PADDR_0 32'h00020fff
...
// Dependencies: The decoder must be configured as internal 
// (when APB_HAS_XDCDR = 0).
`define END_PADDR_1 32'h00021fff
...
`define R0_APB_SA 32'h20000


`define R0_APB_EA 32'h21fff
